...
{  
    ...
    ajaxZaSve("data/proizvodi.json","get",function(result)
    {
        ...
        result.forEach(element => {
            ...
            </a></div><div class="dodajKorpa"style=" width:max-content ;  bottom: 0px!important;position: absolute;">    <h2 style="background-color:#2e443f;color:white;">Телефон за куповину:</br><a class="a1234"  target="_blank"  href="tel:0645877322"><i class="fa fa-phone"style="color:white;font-size:25px">&nbsp;&nbsp;&nbsp;</i> 0645877322</a>.otac Milan Madzarevic<h2>
            </div>
            </div>
